                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="text_outer">
                                        ...
                                        <select class="select_status form-control" name="website">
                                            <option value="{{ $maintanance->website  }}">
                                                {{ $maintanance->website  }}</option>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="text_outer">
                                        ...
                                        <select class="select_status form-control" name="priority">
                                            <option value="{{ $maintanance->priority  }}">
                                                {{ $maintanance->priority  }}</option>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="text_outer">
                                        ...
                                        <select class="select_status form-control" name="category">
                                            <option value="{{ $maintanance->category  }}">
                                                {{ $categorya1->categoryname  }}</option>
                                            <?php foreach ($category as $category_ex_report) { ?>
                                                <option value="{{ $category_ex_report->id  }}">
