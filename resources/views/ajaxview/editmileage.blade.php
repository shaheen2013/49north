                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="text_outer">
                                    ...
                                    <input type="number" id="kilometers" name="kilometers" class="form-control" placeholder="Insert figure here" value={{isset($mileagedetails->date) ? $mileagedetails->kilometers : ''}}>
                                </div>
