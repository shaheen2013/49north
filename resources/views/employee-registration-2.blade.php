...
@section('content1')
    ...
    <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade employeeagreements" id="nav-agreements" role="tabpanel"
             aria-labelledby="nav-agreements-tab">
        ...
        <!--------------statements-------------->
        <div class="tab-pane fade" id="nav-statements" role="tabpanel"
             aria-labelledby="nav-statements-tab">
            <div class="agreements">


                <h3><span class="active-span" id="active_contracts_span">Active Contracts </span> |
                    <span id="old_contracts_span"> Old Contracts</span></h3>
