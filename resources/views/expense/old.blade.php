    ...
    <div class="well-default-trans">
        <div class="tab-pane" id="nav-expense" role="tabpanel" aria-labelledby="nav-employee-tab">
            <div class="expense inner-tab-box">
                <div class="col-md-12">
                    <h3><span class="active-span"
                              onclick="searchExpensePage(this.value)">Pending </span> |
                        <span onclick="expense_history_new(this.value)"> Historical</span>
                    </h3>
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <input type="date" name="date" id="date" placeholder="Select Date"
                                       class="form-control-new" onChange="searchExpensePage()">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <input type="text" placeholder="Search employee" onkeyup="searchExpensePage()"
                        ...
                        <div id="historical_div" style="display:none;" class="col-sm-12">
                            <table class="table table-bordered">
                                ...
                                <tbody class="return_expence_ajax_history" id="expense_search_history">
            ...
            $.ajax({
                ...
                success: function (results) {
                    ...
                    if (results.status === 'success') { 
                        ...
                        $('#expense_search_history').html(html);
                    } else {
                        swal("Error!", results.message, "error");
                    }
                }
