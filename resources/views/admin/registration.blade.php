...
<div class="tab-pane fade show active" id="nav-employee" role="tabpanel" aria-labelledby="nav-employee-tab">
                    <form id="contacts_form" method="POST" name="contact-form" action="{{url('admin/add_registration')}}" enctype="multipart/form-data">
                            @csrf
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="text_outer">
                                        ...
                                        <input type="text" id="familycircum" name="familycircum" class="form-control" placeholder="Insert text here" value={{isset($employee_details->familycircumstance) ?  $employee_details->spclfamilycircumstace : ''}}>
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-3">
                                    <div class="text_outer">
                                        ...
                                        <input type="text" id="dietary_restrictions" name="dietary" class="form-control" placeholder="Insert text here">
                                    </div>
                                </div>
